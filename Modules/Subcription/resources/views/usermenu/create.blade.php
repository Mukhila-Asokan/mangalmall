...
<div class="col-12">
    <div class="card">
        ...
        <form class="form-horizontal" role="form" method = "post" action="{{ route('usermenu.menu_add') }}">
            @csrf
            <div class="col-12">
            <div class="mb-4 row">
            ...
            <div class="mb-4 row">
                ...
                <div class="col-md-8">
                        <input type="text" id="sortorder" name="sortorder" class="form-control" placeholder="Enter the sort order" value = "{{ old('sortorder') }}">
                        @error('sortorder')
                        <div class="text-danger">{{ $message }}</div>
                        @enderror
                </div>
