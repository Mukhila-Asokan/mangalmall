    ...
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                ...
                <form class="form-horizontal" role="form" method="post" action="{{ route('webpage.add') }}" enctype="multipart/form-data">
                    @csrf
                    <div class="col-6">
                        <div class="mb-4 row">
                            <label class="col-md-4 col-form-label" for="webpagename">Web Page Name</label>
                            <div class="col-md-8">
                                <input type="text" id="webpagename" name="webpagename" class="form-control" placeholder="Enter the Web Page name" value="{{ old('webpagename') }}" required>
                            ...
                            <div class="col-md-8">
                                <select id="occasiontype" name="occasiontype" class="form-control" required>
                                    ...
                                    @foreach($occasiontype as $occasionType)
                                        <option value="{{ $occasionType->id }}" {{ old('occasiontype') == $occasionType->id ? 'selected' : '' }}>
