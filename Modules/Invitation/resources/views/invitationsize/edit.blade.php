...
<div class="col-12">
    <div class="card">
        ...
        <form class="form-horizontal" role="form" method = "post" action="{{ route('invitation.size_update', $invitationsize->id) }}">
            @csrf
            @method('PUT')
            <div class="col-6">
            <div class="mb-4 row">
                ...
                <div class="col-md-8">
                        <input type="text" id="sizename" name="sizename" class="form-control" placeholder="Enter the Size name" value = "{{ old('sizename', $invitationsize->sizename) }}">
                        @error('sizename')
