    ...
    <div class="col-12 mt-3">
        <div class="card">
                <div class="card-header text-bg-primary">
                    <h4 class="mb-0 text-white">Update the venue details</h4>
                </div>
                <form action="{{ route('venueadmin/venueupdate', $venue->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="justify-content-center d-flex mb-3 mt-3">
                        <button type="submit" class="btn btn-primary waves-effect waves-light">Update Venue </button>
                    </div>
                </form>
            </div>
        </div>
