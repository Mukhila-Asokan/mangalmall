                            ...
                            @foreach($addons as $addon)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="{{ url('/venueadmin/bookingadons/'.$addon->id.'/edit') }}" class="btn btn-info" title="Edit">
                                            <i class="bi bi-pencil-fill"></i> 
                                        </a>
                                        
                                        <button type="button" class="btn btn-danger deleteid" data-bs-toggle="modal"  data-bs-target="#delModal" data-id="{{ $addon->id }}" title="Delete">
