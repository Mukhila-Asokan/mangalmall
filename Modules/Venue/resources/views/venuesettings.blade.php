                            ...
                            <div class="col-md-4">
                                <div class="card border border-secondary">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <a href="{{ route('venueamenities/create') }}" class="btn btn-secondary waves-effect waves-light">Add</a>
                                        <a href="{{ route('venue/venueamenities') }}" class="btn btn-secondary waves-effect waves-light">View</a>
                                    </div>
                                </div>
                                <!-- end card-box-->
                            </div>
