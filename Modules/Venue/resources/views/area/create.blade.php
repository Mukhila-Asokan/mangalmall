    ...
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                ...
                <form class="form-horizontal" role="form" method="post" action="{{ route('venue.area_add') }}">
                    @csrf
                    <div class="col-6">
                        <div class="mb-4 row">
                            <label class="col-md-4 col-form-label" for="areaname">Area Name</label>
                            <div class="col-md-8">
                                <input type="text" id="areaname" name="areaname" class="form-control" placeholder="Enter the Area name" value="{{ old('areaname') }}">
                                @error('areaname')
                        ...
                        <div class="mb-4 row">
                            ...
                            <div class="col-md-8">
                                <input type="text" id="pincode" name="pincode" class="form-control" placeholder="Enter the Pincode" value="{{ old('pincode') }}">
                                @error('pincode')
                                <div class="text-danger">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="mb-4 row">
                            ...
                            <div class="col-md-8">
                                <select name="districtid" class="form-control" id="districtDropdown">
                                    ...
                                    <option value="{{ $dis->id }}" {{ old('districtid') == $dis->id ? 'selected' : '' }}>{{ $dis->districtname }}</option>
                                    @endforeach
                                </select>
                                @error('districtid')
                                <div class="text-danger">{{ $message }}</div>
                        ...
                        <div class="mb-4 row">
                            ...
                            <div class="col-md-8">
                                <select name="cityid" class="form-control" id="cityDropdown">
                                    ...
                                    <option value="{{ $city->id }}" {{ old('cityid') == $city->id ? 'selected' : '' }}>{{ $city->cityname }}</option>
                                    @endforeach
                                </select>
                                @error('cityid')
                                <div class="text-danger">{{ $message }}</div>
                    ...
                    <div class="justify-content-end row">
                        <div class="col-sm-9">
                            <button type="submit" class="btn btn-primary waves-effect waves-light">Add Area</button>
                        </div>
                    </div>
                </form>
            </div>
