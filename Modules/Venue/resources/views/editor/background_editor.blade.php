	...
	<div class="mt_detail_editor">
		<div class="mt_editor_tabs">
			<ul class="nav nav-tabs" id="backgroundsetting" role="tablist">
				<li class="nav-item">
					<a class="nav-link bgsetcolortbclk active" data-toggle="tab" href="#bgsetcolortb" role="tab" aria-controls="bgsetcolortb" aria-selected="true"><?php echo html_escape($this->lang->line('ltr_common_bg_editor_txt_2')); ?></a>
				</li>
				<li class="nav-item">
				...
				<li class="nav-item">
					<a class="nav-link hideShoSection" data-toggle="tab" href="#hideShoSecTb" role="tab" aria-controls="hideShoSecTb" aria-selected="false"><?php echo html_escape($this->lang->line('ltr_common_bg_editor_txt_24')); ?></a>
				</li>
			</ul>
				...
				<div class="tab-pane fade" id="hideShoSecTb" role="tabpanel" aria-labelledby="hideShoSecTb-tab">
					<div class="flex-hideShow-copy">
						<div class="mt-switch-wrapper">
							<p class="mt-switch-lable"><?php echo html_escape($this->lang->line('ltr_common_bg_editor_txt_25')); ?></p>
						...
						<div class="mt-copy-section">
							<p class="mt-copy-lable"><?php echo html_escape($this->lang->line('ltr_common_bg_editor_txt_26')); ?></p>
							<button class="sectionCopy_btn" id="copyEditable" edit_type="background"><svg width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
								...
								</svg><?php echo html_escape($this->lang->line('ltr_common_bg_editor_txt_27')); ?>
							</button>
						</div>
						<p class="mt-noteSlide"><span><?php echo html_escape($this->lang->line('ltr_common_bg_editor_txt_28')); ?>:-</span> <?php echo html_escape($this->lang->line('ltr_common_bg_editor_txt_29')); ?></p>
						<p class="mt-noteSlide"><span><?php echo html_escape($this->lang->line('ltr_common_bg_editor_txt_28')); ?>:-</span> <?php echo html_escape($this->lang->line('ltr_common_bg_editor_txt_30')); ?></p>
					</div>
				</div>
			</div>
		</div>
