     ...
     <form method="GET" action="{{ route('venue.city') }}" class="mb-4">
        <div class="row">
            ...
            <div class="col-md-2">
                ...
                <a href="{{ route('venue.city') }}" class="btn btn-secondary">Reset</a>
            </div>
        </div>
    </form>
                </div>
...
<div class="d-flex justify-content-center"> {{-- Center the pagination --}}
    {{ $city->appends(request()->query())->links('pagination::bootstrap-4') }}
...
@endsection
<input type="hidden" name="redirecturl" id="redirecturl" value="{{ url('/admin/city/') }}">  
