        ...
        @php $i=1; @endphp
            ...
            <tr>
                ...
                <td>@if($state->status == 'Active')
                    <button type="button" class="btn btn-primary statusid" data-bs-toggle="modal"  data-bs-target=".statusModal"  data-id="{{ $state->id }}" title="Status"><i class="fa fa-eye action_icon"></i></button>
                @else 
                <button type="button" class="btn-info btn statusid" data-bs-toggle="modal"  data-bs-target=".statusModal" data-id="{{ $state->id }}" title="Status"><i class="fa fa-eye-slash action_icon"></i></button>
                @endif
