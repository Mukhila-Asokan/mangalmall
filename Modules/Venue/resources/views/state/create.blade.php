         ...
         <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <form class="form-horizontal" role="form" method = "post" action="{{ route('venue.state_add') }}">
                        @csrf
                        <div class="col-6">
                        <div class="mb-4 row">
                            <label class="col-md-4 col-form-label" for="statename">State Name</label>
                            <div class="col-md-8">
                                <input type="text" id="statename" name="statename" class="form-control" placeholder="Enter the State name" value = "{{ old('statename') }}" >
                                @error('statename')
