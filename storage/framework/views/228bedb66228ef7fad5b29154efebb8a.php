    <!-- Brand Logo Light -->
                ...
                <div class="h-100" id="leftside-menu-container" data-simplebar>
                    ...
                    <div class="leftbar-user">
                        <a href="#">
                            <img src="<?php echo e(asset('venueasset/images/users/avatar-1.jpg')); ?>" alt="user-image" height="42" class="rounded-circle shadow-sm">
                    ...
                    <ul class="side-nav">
                        ...
                        <li class="side-nav-item">
                            <a href="<?php echo e(route('venueadmin/dashboard')); ?>" class="side-nav-link">
                        ...
                        <li class="side-nav-item">
                            <a href="<?php echo e(route('venue.calendar')); ?>" class="side-nav-link">
                        ...
                        <li class="side-nav-item">
                            ...
                            <div class="collapse" id="sidebarBaseUI">
                                <ul class="side-nav-second-level">
                                    <li>
                                        <a href="<?php echo e(route('venueadmin/create')); ?>">Add Venue</a>
                                    </li>
                                    <li>
                                        <a href="<?php echo e(route('venueadmin/venuelist')); ?>">List Venue</a>
                                    </li>
                                    <li>
                                        <a href="<?php echo e(route('venuebookinglist')); ?>">Booking Details</a>
                                    </li>  
                                    <li>
                                        <a href="<?php echo e(route('get.all.enquiries')); ?>">Booking Enquiries</a>
                                    </li> 
                                    <li>
            ...
            <li class="side-nav-item">
                            ...
                            <div class="collapse" id="sidebarsettings">
                                <ul class="side-nav-second-level">
                                <li>  <a href="<?php echo e(route('venueadmin.changemobileno')); ?>">Change Mobile No</a></li> 
                                    <li>
                                        <a href="<?php echo e(route('venue.bookingadons')); ?>">Booking Adds</a>
                                    </li> 
                                    <li>  <a href="<?php echo e(route('venueadmin.userprofile')); ?>">User Profile</a></li>                                  
                                </ul>
                            </div>
                   </li>
            ...
            <li class="side-nav-item">
                            <a href="<?php echo e(route('venueadmin/logout')); ?>" class="side-nav-link">
                    ...
                    <!--- End Sidemenu -->
                     ...
                     <div class="bg-flower-bot">
                      <img src="<?php echo e(asset('venueasset/images/flowers/img-4.png')); ?>">
                  </div>


                    <div class="clearfix"></div>
                </div><?php /**PATH C:\xampp\htdocs\mangalmall\Modules/VenueAdmin\resources/views/layouts/left-sidemenubar.blade.php ENDPATH**/ ?>