            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-8 col-md-8">
                    	  ...
                    	  <!-- Post-->
                        <article class="post">
                            <div class="post-preview"><img src="<?php echo e($bannerurl); ?>" alt="article" class="img-fluid" /></div>
...
<?php echo $__env->make('layouts.guest', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\mangalmall\resources\views/home/venuedetail.blade.php ENDPATH**/ ?>