...
<html lang="en">
  ...
  <head>
	...
	<link rel="stylesheet" href="<?php echo e(asset('adminassets/editor_assets/css/typekitcss.css')); ?>">
		...
		<div class="mt_dashboard_section">
			<div class="mt_sidebar_main">
				...
				<div class="mt_sidebar_logos">
					<a href="#"><img src="<?php echo e(asset('adminassets/editor_assets/images/logo.png')); ?>" title="" alt="Logo"/></a>
				</div>
			...
			<div class="mt_main_structure">
				<div class="mt_structure_header">
					...
					<div class="mt_header_left">
						<div class="mt_sidebar_logos">
							<a href="#"><img src="<?php echo e(asset('adminassets/images/logo-light.png')); ?>" title="" alt=""></a>
						</div>
						<a href="<?php echo e(url()->previous()); ?>" class="mt_btn mt_back_btn"><svg xmlns="http://www.w3.org/2000/svg" width="12" height="7">
					...
					<div class="mt_st_heading">
                        <h3>Edit - <?php echo e($theme->webpagename); ?></h3>
					</div>
					...
					<?php 
					        $preview_imageurl = url("home/webpage/".$theme->id."/preview");

						?>
					     <a href="<?php echo e($preview_imageurl); ?>" target="_blank" class="mt_btn mt_edt_view_button" >
					    ...
					    <a href="javascript:;" class="mt_btn mt_edt_save_button pxg_save_admin_template" data-temp-id="<?php echo e($theme->id); ?>" ><svg xmlns="http://www.w3.org/2000/svg" width="14" height="15">
								...
								<button type="button" class="btn btn-primary d-flex align-items-center gap-2" data-bs-toggle="modal" data-bs-target="#publishModal">
						...
						<ul class="d-none">
							<li>Hello <p><?php echo e(Auth::user()->id); ?></p></li>
							<li><a href="#"><img src="<?php echo e(asset('adminassets/editor_assets/images/avatar.png')); ?>"/></a></li>
						</ul>
					</div>
					<div class="mt_profile_open d-none">
						<img src="<?php echo e(asset('adminassets/editor_assets/images/border-shape.svg')); ?>"/>
						<ul>
				...
				</div><?php /**PATH C:\xampp\htdocs\mangalmall\resources\views/editor/header.blade.php ENDPATH**/ ?>