         ...
         <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <form class="form-horizontal" role="form" method = "post" action="<?php echo e(route('venue.city_update', $city->id)); ?>">
                        <?php echo csrf_field(); ?>
                        ...
                        <div class="mb-4 row">
                            ...
                            <div class="col-md-8">
                                <input type="text" id="cityname" name="cityname" class="form-control" placeholder="Enter the City name" value = "<?php echo e(old('cityname', $city->cityname)); ?>" >
                        ...
                        <div class="mb-4 row">
                            ...
                            <div class="col-md-8">
                                <select name="stateid" class="form-control" id ="stateDropdown">
                                    ...
                                    <option value="<?php echo e($sta->id); ?>" <?php echo e(old('stateid', $city->stateid) ==  $sta->id ? 'selected' : ''); ?> > <?php echo e($sta->statename); ?></option>
                       ...
                       <div class="mb-4 row">
                           ...
                           <div class="col-md-8">
                               <select name="districtid" class="form-control" id="districtDropdown">
                                   ...
                                   <option value="<?php echo e($dis->id); ?>" <?php echo e(old('districtid', $city->districtid) ==  $dis->id ? 'selected' : ''); ?> > <?php echo e($dis->districtname); ?></option>
                                   <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                               </select>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('admin.layouts.app-admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\mangalmall\Modules/Venue\resources/views/city/edit.blade.php ENDPATH**/ ?>