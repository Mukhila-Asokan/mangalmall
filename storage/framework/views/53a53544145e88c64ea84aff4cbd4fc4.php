     ...
     <form method="GET" action="<?php echo e(route('venue.city')); ?>" class="mb-4">
        <div class="row">
            ...
            <div class="col-md-2">
                ...
                <a href="<?php echo e(route('venue.city')); ?>" class="btn btn-secondary">Reset</a>
            </div>
        </div>
    </form>
                </div>
...
?>
            ...
            <tr>
                ...
                <td><?php if($dist->status == 'Active'): ?>
                    <button type="button" class="btn btn-primary statusid" data-bs-toggle="modal"  data-bs-target=".statusModal"  data-id="<?php echo e($dist->id); ?>" title="Active Status"><i class="fa fa-eye action_icon"></i></button>
                <?php else: ?> 
                <button type="button" class="btn-info btn statusid" data-bs-toggle="modal"  data-bs-target=".statusModal" data-id="<?php echo e($dist->id); ?>" title="Inactive Status"><i class="fa fa-eye-slash action_icon"></i></button>
                <?php endif; ?>
                <a href="<?php echo e(url('/admin/city/'.$dist->id.'/edit')); ?>" class="btn-warning btn" title="Edit"><i class="fa fa-pencil action_icon"></i>
                </a>
...
<div class="d-flex justify-content-center"> 
    <?php echo e($city->appends(request()->query())->links('pagination::bootstrap-4')); ?>
...
<input type="hidden" name="redirecturl" id="redirecturl" value="<?php echo e(url('/admin/city/')); ?>">  
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('admin.layouts.app-admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\mangalmall\Modules/Venue\resources/views/city/index.blade.php ENDPATH**/ ?>