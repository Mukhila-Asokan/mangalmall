...
<div class="mt_sidebar_editor" id="customcss_editor">
                    ...
                    <path d="M7.5 14.5L1 8L7.5 1.5" stroke="black" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>
						...
						<div class="mt_detail_editor mt_css_js">
							<div class="mt_select_editor mt_edit_text">
								<p>Add Custom CSS</p>
								<textarea  placeholder="Add CSS Here" id="mt_custom_css" name = "custom_css"><?php echo e($template->custom_css ?? ''); ?></textarea>
							</div>
							<div class="mt_select_editor mt_edit_text">
								<p>Add Custom JS</p>
								<textarea  placeholder="Add JS Here" id="mt_custom_js" name = "custom_js"><?php echo e($template->custom_js ?? ''); ?></textarea>
							</div>
					...
					</div><?php /**PATH C:\xampp\htdocs\mangalmall\Modules/Venue\resources/views/editor/customcss_editor.blade.php ENDPATH**/ ?>