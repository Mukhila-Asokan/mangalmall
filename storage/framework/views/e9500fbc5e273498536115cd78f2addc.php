...
<div class="col-12">
    <div class="card">
        <div class="card-body">
            ...
            <div class="text-end">
                <a href = "<?php echo e(route('admin.eventbudget.index')); ?>" class="btn btn-primary waves-effect waves-light mb-4 text-end">
                                <span class="tf-icon mdi mdi-eye me-1"></span>Budget List
                </a>
            </div>
        <form class="form-horizontal" role="form" method = "post" action="<?php echo e(route('admin.eventbudget.store')); ?>">
            <?php echo csrf_field(); ?>
            <div class="col-6">
...
<script>
    $(document).ready(function() {
        ...
        $('#category_id').on('change', function() {
            ...
            if (categoryId) {
                $.ajax({
                    url: "<?php echo e(route('admin.budgetitems.get')); ?>", // Create this route
                    type: 'GET',
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('admin.layouts.app-admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\mangalmall\Modules/Settings\resources/views/eventbudget/create.blade.php ENDPATH**/ ?>