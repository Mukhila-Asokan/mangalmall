...
<input type="hidden" id="template_id" value="<?php echo e($template_id); ?>">
<input type="hidden" id="campaign_id" value="<?php echo e($campaign_id ?? ''); ?>">
...
<script src="<?php echo e(asset('assets/js/aligning_guidelines.min.js')); ?>"></script>
<script src="<?php echo e(asset('assets/js/centering_guidelines.min.js')); ?>"></script>
<script src="<?php echo e(asset('assets/js/jquery.toaster.js')); ?>"></script>
<script src="<?php echo e(asset('assets/js/color-name-hue.js')); ?>"></script>
<script>var admin = true;</script>
<script src="<?php echo e(asset('assets/js/fabric.min.js')); ?>"></script>
<script src="<?php echo e(asset('assets/js/jquery-ui.min.js')); ?>"></script>
<script src="<?php echo e(asset('assets/js/coloris.min.js')); ?>"></script>
<script src="https://cdnjs.cloudflare.com/ajax/libs/jspdf/2.5.1/jspdf.umd.min.js"></script>
<script src="<?php echo e(asset('assets/js/canvas-custom.js')); ?>?q=<?php echo e(time()); ?>"></script>
<script src="<?php echo e(asset('assets/js/editor-custom.js')); ?>?q=<?php echo e(time()); ?>"></script>
<span id="pg_ajax_url" data-ajax_url="<?php echo e(url('/')); ?>"></span>
<script>
    const saveTemplateUrl = "<?php echo e(route('cardinvitation.save_template')); ?>";
</script>
<script>
/**
 * Color Switcher
...
for (let i = 0; i < elements.length; i++) {
    ...
    let drag_style = "<?php echo e(asset('assets/css/dark-style.css')); ?>?q=1";
...
</script><?php /**PATH C:\xampp\htdocs\mangalmall\resources\views/cardeditior/footer.blade.php ENDPATH**/ ?>