...
<script type="text/javascript">
	$(function () {
		var table = $('.data-table').DataTable({
			processing: true,
			serverSide: true,
			ajax: "<?php echo e(route('venue.comments')); ?>",
			columns: [
				{ 
					data: 'id', 
					name: 'id',
	...
	$('.bulk_action').on('click', function(){
		$.ajax({
			url: "<?php echo e(route('bulk.comments.action')); ?>",
			type: "GET",
			data: { 
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('admin.layouts.app-admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\mangalmall\Modules/Venue\resources/views/venues/comments.blade.php ENDPATH**/ ?>