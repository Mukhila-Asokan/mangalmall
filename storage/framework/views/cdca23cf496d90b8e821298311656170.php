                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-6 text-start">
                                <a href = "<?php echo e(url('/admin/venue/'.$venuedetails->id.'/allhall')); ?>" class="btn btn-primary waves-effect waves-light mb-4 text-end" target="_new">
                                        <span class="tf-icon mdi mdi-file-image me-1"></span>Add Hall
                                </a>
                            </div>
                            <div class="col-6 text-end">
                                <a href = "<?php echo e(route('venue.allhall',$venuedetails->parentid)); ?>" class="btn btn-primary waves-effect waves-light mb-4 text-end">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td><h4 class="header-title">Hall Name - <?php echo e($venuedetails->venuename); ?></h4></td>
                                <td colspan="2" class="text-center">
                                    <img src = "<?php echo e(url('/').Storage::url('/').$venuedetails->bannerimage); ?>" style="width:100px" /></td>
                            </tr>
                            <tr>
                                <td><h4 class="header-title">Parent Venue Name</h4></td>
                                <td colspan="2"><?php echo e($venuedetails->venuename); ?></td>
                            </tr>
                            <tr>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('admin.layouts.app-admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\mangalmall\Modules/Venue\resources/views/venues/hallshow.blade.php ENDPATH**/ ?>