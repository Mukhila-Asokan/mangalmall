...
<div class="row">
         ...
         <form action="<?php echo e(route('state.update', $state->id)); ?>" method="POST">
             <?php echo csrf_field(); ?>
        ...
        <div class="col-6">
            <div class="mb-4 row">
                ...
                <div class="col-md-8">
                    <input type="text" id="statename" name="statename" class="form-control" placeholder="Enter the State name" value = "<?php echo e($state->statename); ?>" >
...
<?php echo $__env->make('admin.layouts.app-admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\mangalmall\Modules/Venue\resources/views/state/edit.blade.php ENDPATH**/ ?>