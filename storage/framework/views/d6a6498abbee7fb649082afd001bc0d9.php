					...
					<div class="mt_dropzon_section mt_dropzon_img2">
						<div class="mt_select_editor">
							...
							<div class="mt_dropzon">
								<form action="<?php echo e(route('home.fileupload')); ?>" class="dropzone" id="imgbackgroundupload"><?php echo csrf_field(); ?></form>
							</div>
						</div>
					</div>
					<div class="mt_editor_tabs">
...
</div><?php /**PATH C:\xampp\htdocs\mangalmall\resources\views/editor/background_editor.blade.php ENDPATH**/ ?>