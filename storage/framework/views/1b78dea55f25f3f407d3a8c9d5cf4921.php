                    ...
                    <ul class="topbar-menu d-flex align-items-center gap-3">
                        ...
                        <li class="dropdown notification-list">
                            <a class="nav-link dropdown-toggle arrow-none" data-bs-toggle="dropdown" href="#" role="button" aria-haspopup="false" aria-expanded="false">
                                ...
                                <?php if(count($venueUser->unreadNotifications) > 0): ?>
                            ...
                            <div class="dropdown-menu dropdown-menu-end dropdown-menu-animated dropdown-lg py-0">
                                <div class="p-2 border-top-0 border-start-0 border-end-0 border-dashed border">
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col-auto">
                                            <a href="<?php echo e(route('mark.as.read')); ?>" class="text-dark text-decoration-underline">
                                ...
                                <!-- All-->
                                <a href="<?php echo e(route('get.all.notifications')); ?>" class="dropdown-item text-center text-primary text-decoration-underline fw-bold notify-item border-top border-light py-2">
                                    View All
                                </a>
...
<?php $__env->stopPush(); ?><?php /**PATH C:\xampp\htdocs\mangalmall\Modules/VenueAdmin\resources/views/layouts/topbar.blade.php ENDPATH**/ ?>