                     ...
                     <div class="row justify-content-center">
                          <div class="col-md-9 col-lg-8">
                                <div class="section-heading text-center mb-5">
                                     <h2>Edit Blog - Let’s Continue the Adventure!</h2>
                                </div>
                          </div>
                     </div>
                     ...
                     <div class="row">
                          <div class="col-md-8">  
                                <div class="mb-3">
                                     ...
                                     <input type="text" class="form-control" id="blogtitle" name="title" placeholder="Enter the Blog Title" value="<?php echo e(old('title', $blog->title)); ?>">
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="mb-3">
                                     ...
                                     <input type="text" class="form-control" id="slug" name="slug" placeholder="slug" value="<?php echo e(old('slug', $blog->slug)); ?>">
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="mb-3">
                                     ...
                                     <textarea class="form-control" id="blogcontent" placeholder="Enter the Blog Content" name="content" style="height:600px;"><?php echo e(old('content', $blog->content)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                          ...
                          <div class="col-md-4">  
                                <div class="mb-3 text-center">
                                     <img id="imagePreview" src="<?php echo e($blog->image ? asset('storage/' . $blog->image) : asset('frontassets/img/preview.jpg')); ?>" alt="Mangal Mall Image Preview" style="width:350px"/>
                                </div>
                                <div class="mb-3">
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="mb-3">
                                     ...
                                     <select class="form-control" id="blogcategory" name="category">
                                          ...
                                          <option value="<?php echo e($category->id); ?>" <?php echo e(old('category', $blog->category_id) == $category->id ? 'selected' : ''); ?>><?php echo e($category->categoryname); ?></option>
                                          <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                     </select>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="mb-3">
                                     ...
                                     <select class="form-control" id="blogstatus" name="blogstatus">
                                          <option value="draft" <?php echo e(old('blogstatus', $blog->status) == 'draft' ? 'selected' : ''); ?>>Draft</option>							
                                          <option value="published" <?php echo e(old('blogstatus', $blog->status) == 'published' ? 'selected' : ''); ?>>Published</option>
                                          <option value="rejected" <?php echo e(old('blogstatus', $blog->status) == 'rejected' ? 'selected' : ''); ?>>Trash</option>						
                                     </select>
                                </div>	
...
<script>
    ...
    var defaultTags = <?php echo json_encode(explode(', ', $blog->tags)) ?>;

    var tagify = new Tagify(input, {
        whitelist: <?php echo json_encode($tags->pluck('tagname')->toArray(), 15, 512) ?>, // Available tags
        dropdown: {
            maxItems: 5,
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('profile-layouts.profile', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\mangalmall\resources\views/blog/edit.blade.php ENDPATH**/ ?>