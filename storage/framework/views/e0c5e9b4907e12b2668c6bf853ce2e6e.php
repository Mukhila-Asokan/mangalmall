            ...
            <div class="mb-4">
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="float-end mt-3">
                            <p><b>Hello, <?php echo e($venuebooking->contact->person_name); ?></b></p>
                        </div>
                    </div><!-- end col -->
                ...
                <div class="row mt-4">
                    <div class="col-4">
                        ...
                        <address>
                        <?php echo e($venuebooking->contact->person_name); ?><br>
                        <?php echo e($venuebooking->contact->contact_address); ?> <br>
                          
                            <abbr title="Phone">P:</abbr><?php echo e($venuebooking->contact->mobileno); ?>
...
<div class="mt-3">
    ...
    <div class="row py-2">
        ...
        <div class="col">
            <select name="venueprice" class="form-select" id="selectvenueprice">
                ...
                <option value="<?php echo e($venuebooking->venuepricing->base_price); ?>">Base Price</option>
                <option value="<?php echo e($venuebooking->venuepricing->peak_rate); ?>">Peak Price</option>
    ...
    <?php $total = 0; ?>
        ...
        <?php $__currentLoopData = $venuebooking->venuepricing->addons; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $addon): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
         ...
         <div class="row py-2 addon-item">
                <div class="col"><?php echo e($index + 2); ?></div>
                <div class="col">
                    <input type="hidden" name="addonid[]" value="<?php echo e($addon->id); ?>" />
                    <input type="text" name="addonidval[]" class="form-control" value="<?php echo e($bookingpriceaddon->addonname); ?>" />
                </div>
                <div class="col">
                    <input type="text" name="addonprice[]" class="form-control addon-price" value="<?php echo e($addon->addonprice); ?>" />
                </div>
    ...
    <div class="row py-2 border-top">
        ...
        <div class="col text-end">
           <h4> <b id="total-cost"><i class="bi bi-currency-rupee me-3 fs-20"></i> <?php echo e(number_format($total, 2)); ?></b></h4>
        </div>
    </div>
</div>
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="clearfix pt-3">
                            ...
                            <small>
                            <?php echo e($venuebooking->venuepricing->cancellation_policy); ?>
...
<?php echo $__env->make('venueadmin::layouts.admin-layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\mangalmall\Modules/VenueAdmin\resources/views/booking/invoicegenerator.blade.php ENDPATH**/ ?>