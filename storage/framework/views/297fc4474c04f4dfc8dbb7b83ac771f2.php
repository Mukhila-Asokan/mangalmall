...
<div class="col-12">
    <div class="card">
        <div class="card-body">
            ...
            <div class="text-end">
                    <a href = "<?php echo e(route('admin.checklistcat.create')); ?>" class="btn btn-primary waves-effect waves-light mb-4 text-end"><span class="tf-icon mdi mdi-plus me-1"></span> Add </a>
            </div>
    ...
    <?php endif; ?>
    <a href="<?php echo e(route('admin.checklistcat.edit',$cat->id)); ?>" class="btn-warning btn" title="Edit"><i class="fa fa-pencil action_icon"></i>
    </a>
...
<input type="hidden" name="redirecturl" id="redirecturl" value="<?php echo e(url('/admin/settings/checklistcat/')); ?>">
<?php echo $__env->make('admin.layouts.app-admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\mangalmall\Modules/Settings\resources/views/checklistcat/index.blade.php ENDPATH**/ ?>