...
<?php $__env->startSection('content'); ?>
	<div class="m-3 h3 d-flex" style="font-weight: bold;">
		Welcome <span class="font-color mleft-10"><?php echo e($user->name); ?> </span> &nbsp;!
	</div>
	<div class="row m-2">
		<div class="col-lg-4 col-sm-4 col-md-4">
			<div class="card shadow-sm">
				...
				<div class="card-footer text-center bg-light">
					<a href="<?php echo e(route('get.all.enquiries')); ?>" class="btn btn-primary btn-sm">View All Enquiries</a>
				</div>
			</div>
		</div>
...
<?php $__env->startPush('scripts'); ?>
	<script>
		$(document).ready(function(){
			$.ajax({
				url: "<?php echo e(route('get-dashboard-data')); ?>",
				type: "GET",
				headers: {
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('venueadmin::layouts.admin-layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\mangalmall\Modules/VenueAdmin\resources/views/auth/dashboard.blade.php ENDPATH**/ ?>