...
<?php $__env->startSection('content'); ?>
                                    ...
                                    <?php if(count($useroccasion) > 0): ?>
                                        <?php $__currentLoopData = $useroccasion; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $occasion): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <div class="col-md-4 mb-4 p-2">
                                                <a href="<?php echo e(route('view.event.page', ['id' => $occasion->id])); ?>">
                                                    <div class="card contact-card shadow-lg border-0 rounded-3">
                                                        <div class="card-body">
                                                        <div class="d-flex justify-content-between align-items-center">
                                                            <h5 class="card-title text-primary mb-0 h5"><?php echo e($occasion->occasion_name); ?></h5>
                                                            <!-- <div>
                                                        ...
                                                        <div class="d-flex row">
                                                            <div class="col-md-6">
                                                                <p class="card-text mt-2 text-muted mb-0 font-14">Event - <?php echo e($occasion->Occasionname->eventtypename); ?></p>
                                                            </div>
    ...
    <?php if($collaborators && $collaborators->pluck('user_id')->contains($currentUserId)): ?>
        <div class="d-flex">
    ...
    <?php else: ?>
        ...
        <div class="d-flex">
            ...
            <p class="card-text mt-2 text-muted mb-0 font-14 text-end ml-1">
                <?php echo e($collaboratorName ?? 'Collaborator'); ?>
    ...
    <?php endif; ?>
                                                        ...
                                                        <hr class="my-3">
                                                        <p class="card-text mb-2"><strong>Date:</strong> <?php echo e(\Carbon\Carbon::parse($occasion->occasiondate)->format('d/m/y')); ?></p>
                                                        <p class="card-text mb-2"><strong>Place:</strong> <?php echo e($occasion->occasion_place); ?></p>
                                                        <p class="card-text mb-2 overflow-hidden"><strong>Notes:</strong> <?php echo e($occasion->notes); ?></p>
                                                        </div>
                                                    </div>
                                                </a>
                                            </div>
