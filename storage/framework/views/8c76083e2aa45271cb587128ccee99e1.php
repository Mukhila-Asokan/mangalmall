                             ...
                             <div class="col-md-4">
                                <div class="card border border-warning">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <a href="<?php echo e(route('venuesubtype/create')); ?>" class="btn btn-warning waves-effect waves-light">Add</a>
                                        <a href="<?php echo e(route('venuesubtype/show')); ?>" class="btn btn-warning waves-effect waves-light">View</a>
                                    </div>
                                </div>
                                <!-- end card-box-->
                            </div>
                              <div class="col-md-4">
                                <div class="card border border-info">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <a href="<?php echo e(route('venuesubtype/create')); ?>" class="btn btn-info waves-effect waves-light">Add</a>
                                        <a href="<?php echo e(route('venuesubtype/show')); ?>" class="btn btn-info waves-effect waves-light">View</a>
                                    </div>
                                </div>
                            </div>
                                  <div class="col-md-4">
