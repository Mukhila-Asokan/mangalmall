				...
				<?php echo $__env->make('venue::editor.text_editor', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
				<?php echo $__env->make('venue::editor.image_editor', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
				<?php echo $__env->make('venue::editor.background_editor', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
				<?php echo $__env->make('venue::editor.form_editor', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
				<?php echo $__env->make('venue::editor.customcss_editor', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>

				<div class="mt_popup_live_preview">
					<div data-replace-path="" class = "mt_edit_template_container 
					<?php if(isset($template)): ?> 
    					<?php echo e($template->template_html != '' ? 'ppd_my_template' : ''); ?>
				    ...
				    <div class="mt_btn_sticky">
    					<div class="mt_next_prev_btn">
    						<ul>
    							<input type="hidden" id="campId" value="<?php echo e($template->id ?? ''); ?>">
    						</ul>
    					</div>
					</div>
				</div>

				<input type="hidden" id="venueid" name = "venueid" value="<?php echo e($venue->id); ?>">
				<input type="hidden" id="venuename" name = "themname" value="<?php echo e($venue->venuename); ?>">
				<input type="hidden" id="themname" name = "themname" value="<?php echo e($theme->themename); ?>"><?php /**PATH C:\xampp\htdocs\mangalmall\Modules/Venue\resources/views/editor/editing_screen_1.blade.php ENDPATH**/ ?>