                          ...
                          <form class="form-horizontal" role="form" method = "post" action="<?php echo e(route('admin.passwordupdate')); ?>">
                                        ...
                                        <div class="mb-2 row">
                                            ...
                                            <div class="col-md-8">
                                                ...
                                                <?php if($errors->has('venuetypename')): ?>
                                                <div class="text-danger"><?php echo e($errors->first('venuetypename')); ?></div>
...
<?php echo $__env->make('admin.layouts.app-admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\mangalmall\Modules/Venue\resources/views/venuetype/create.blade.php ENDPATH**/ ?>