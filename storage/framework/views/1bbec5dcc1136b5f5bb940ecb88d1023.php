    ...
    <div class="col-12 mt-5">
        ...
        <div class="row">
            ...
            <div class="mb-4 row">
                ...
                <div class="col-md-8">
                        <input type="text" id="contacttelephone" name="contacttelephone" class="form-control" placeholder="Enter the Venue Telephone No" value = "<?php echo e(old('contacttelephone')); ?>" required>
            ...
            <div class="mb-4 row">
                ...
                <div class="col-md-8">
                        <input type="text" id="contactemail" name="contactemail" class="form-control" placeholder="Enter the Contact Email Id" value = "<?php echo e(old('contactemail')); ?>" required>
            ...
            <div class="mb-4 row">
                ...
                <div class="col-md-8">
                        <input type="text" id="websitename" name="websitename" class="form-control" placeholder="Enter the Contact Email" value = "<?php echo e(old('websitename')); ?>" required>
...
<div class ="row">
  ...
  <input class="form-control" type="file" id="formFileMultiple" multiple>
                                ...
                                <div class="col-md-8">
                                        ...
                                        <?php if($errors->has('googlemap')): ?>
                                    <div class="text-danger"><?php echo e($errors->first('googlemap')); ?></div>
                                        <?php endif; ?>
