...
<div class="col-12 mt-3">
   <div class="card">
        <div class="card-header text-bg-primary">
            <h4 class="mb-0 text-white">Fill up the venue details</h4>
        </div>
        <form class="form-horizontal mt-3" role="form" method = "post" action="<?php echo e(route('venueadmin/venueadd')); ?>" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
            <div class="col-12">
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('venueadmin::layouts.admin-layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\mangalmall\Modules/VenueAdmin\resources/views/venueuser/create.blade.php ENDPATH**/ ?>