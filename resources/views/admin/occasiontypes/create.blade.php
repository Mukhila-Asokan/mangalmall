...
@section('content')
         <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <h4 class="header-title mb-4">Add Occasion Type</h4>
                         ...
                         <a href = "{{ route('admin/occasion') }}" class="btn btn-primary waves-effect waves-light mb-4 text-end">
                          ...
                          <form class="form-horizontal" role="form" method = "post" action="{{ route('admin/occasion/store') }}">
                                        ...
                                        <div class="mb-4 row">
                                            ...
                                            <div class="col-md-8">
                                                  <input type="text" id="eventtypename" name="eventtypename" class="form-control" placeholder="Enter the Occasion type name" value = "{{ old('eventtypename') }}" required>
                                        ...
                                        <br><br>
                                         <div class="justify-content-end row">
                                                <div class="col-sm-9">
                                                    <button type="submit" class="btn btn-primary waves-effect waves-light">Add Occasion Type</button>
                                                </div>
                                            </div>
                                        </div>
                                    </form>
