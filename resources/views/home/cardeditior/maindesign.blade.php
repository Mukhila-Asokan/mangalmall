<body class="pg-editor-body">
       ...
       <div class="pg-header-wrapper pg-editor-header">
           <div class="pg-header-row">
               <div class="pg-header-col">
                   <div class="pg-logo-wrap">
                          <a href="{{ route('home') }}" class="pg-logo">
                            <img src="{{ asset('assets/images/logo.png') }}" alt="mangalmall">
                          </a>
                   </div>
                   <div class="pg-menu-toggle">
                    ...
                    @if(!empty($template->template_name))
                        <div class="pg_template_name" title="Template Name - {{ $template->template_name }}" data-bs-toggle="tooltip" data-bs-placement="bottom">
               ...
               <div class="pg-header-col">										
                    <div class="pg-header-options-wrap">
						<div class="pg-action-btns">
							<ul>
								<li>
                                    <a href="javascript:void(0);" class="pg-btn pg-btn-primary pg-btn-sm pg-btn-icon" id="saveCard">
                                        <i class="material-icons">save</i>
                                        <span>Save</span>
                                    </a>
                                </li>
                                <li>
                                    <a href="javascript:void(0);" class="pg-btn pg-btn-primary pg-btn-sm pg-btn-icon" id="saveAsTemplate">
                                        <i class="material-icons">save</i>
         ...
         <!-- Header End  -->
            ...
            @include('home.cardeditor.Sidebar')
