...
<style>
    .sidebar {
        ...
        background-image: url("{{ asset('assets/images/sidebar-bg.png') }}");
           ...
           <div class="pg-header-row">
               <div class="pg-header-col col-md-6">
                   ...
                   <div class="pg-logo-wrap col-md-2">
                          <a href="{{ route('inviationcard') }}" class="pg-logo">
                            <img src="{{ asset('assets/images/logo.png') }}" alt="Mangal Mall">
                          </a>
                   </div>
                  
              
					<div class="col-md-2" title="Template Name - {{ $template->template_name ?? 'Template' }}" data-bs-toggle="tooltip" data-bs-placement="bottom" style="float: right;position: relative;top: 20px;margin-left: 30px;">
						Title - {{ $template->template_name ?? 'Template' }}
					</div>
					<div class = "col-md-2">
						<a href = "{{ route('inviationcard') }}" class="btn btn-primary" style="margin-top:20px;">Back</a>	
					</div>					
					</div>
               </div>
